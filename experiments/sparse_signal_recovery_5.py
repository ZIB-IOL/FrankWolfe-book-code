...
LPOracle = probability_simplex(int(2 * n), alpha=5)
...
output_BCG_data = blended_conditional_gradients(
    ...
    x0 = initial_point,
    step_size = step_size_class("line_search"),
    stopping_criteria=stopping_criterion({"iterations": 50, "frank_wolfe_gap":1.0e-8}),
)
...
filepath = os.path.join(
    os.getcwd(), "output_data", "boosted_comparison_version_sparsity5.pickle"
)
...
plot_results(
    ...
    save_figure=os.path.join(output_directory_images, "Boosted_BCG_FOO_5.pdf"),
...
#     x_limits=[1, None],
#     y_limits=[1.0e-11, None],
#     # save_figure=os.path.join(image_target_directory, "Boosted_BCG_LMO_5.pdf"),
# )
...
plot_results(
    ...
    save_figure=os.path.join(output_directory_images, "Boosted_BCG_time_5.pdf"),
    figure_width=figure_size,
)
