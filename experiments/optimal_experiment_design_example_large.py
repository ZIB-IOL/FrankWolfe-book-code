...
data_away_optimized_reference_solution = away_frank_wolfe_optimal_experiment_design(
    ...
    algorithm_parameters={
        ...
        "stopping_frank_wolfe_gap": 1.0e-10,
        "recompute_logdet": True,
    },
)
...
filepath = os.path.join(
    os.getcwd(), "output_data", "optimal_experiment_design_large.pickle"
)
...
output_filepath = os.path.join(
    ...
    "optimal_experiment_primal_gap_iteration_large.pdf",
)
# max_iteration_AFW = 52000
list_x_label = [
...
plot_results(
    ...
    x_limits=[
        ...
        1.0
        + max(
            len(results["FW"]["primal_gap"]),
            len(results["AFW"]["primal_gap"]),
        ),
    ],
...
output_filepath = os.path.join(
    output_directory_images,
    "optimal_experiment_primal_gap_time_large.pdf",
)

list_x_label = [
    [value - results["FW"]["time"][0] for value in results["FW"]["time"]],
    [value - results["AFW"]["time"][0] for value in results["AFW"]["time"]],
]
